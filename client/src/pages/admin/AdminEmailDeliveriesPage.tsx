...
type Delivery = { _id: string; category: string; to: string; subject: string; status: string; attempts: number; providerMessageId?: string; lastError?: string };
