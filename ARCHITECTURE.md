...
- **In MongoDB** (`server/src/models/`): catalogue content, users, hashed sessions/account tokens, orders, entitlements, lessons, lesson progress, certificates and retained webhook-event state.
