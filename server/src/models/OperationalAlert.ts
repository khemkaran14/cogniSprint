...
const operationalAlertSchema = new Schema({
  ...
  category: { type: String, enum: ["payment_failure", "payment_dispute", "stale_order", "webhook_failure", "entitlement_mismatch", "email_failure", "reconciliation_review"], required: true, index: true },
