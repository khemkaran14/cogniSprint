...
export type TransactionalEmail = { idempotencyKey: string; category: "purchase" | "payment_failed" | "refund" | "certificate"; userId?: unknown; to: string; subject: string; text: string };
